...
if(eatsAnimals===true&&eatsPlants===false){console.log("carnivore");}
else if(eatsAnimals===false&&eatsPlants===true){console.log("herbivore");}
else if(eatsAnimals===true&&eatsPlants===true){console.log("omnivore");}
